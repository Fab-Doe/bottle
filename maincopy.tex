...
\addbibresource{references.bib}  % add library manually via texmaker
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\scshape\Large Fabian Doeweler \\ Second Author \\} % Editor list
...
\includegraphics[scale=0.2]{analysis/figures/image.png}
